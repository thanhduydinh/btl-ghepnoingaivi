...
// Khởi tạo cảm biến BME280 để bắt đầu đọc dữ liệu từ nó.
void initBME(){
  if (!bme.begin(0x76)) {
...
// Để cấu hình và khởi tạo các thành phần cần thiết cho BLE và cảm biến BME280.
void setup() {
...
// Để đọc dữ liệu từ cảm biến BME280 và thông báo các giá trị này tới các thiết bị BLE đã kết nối.
void loop() {
  if (deviceConnected) {
